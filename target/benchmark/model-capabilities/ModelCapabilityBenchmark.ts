...
import { FileLogger } from 'src/app/Logging/Logger.js';
import { Project } from 'src/engine/Project/Project.js';
import { ProjectEditor } from 'src/engine/Edit/ProjectEditor.js';
import type { PlanStep } from 'src/engine/Planner/Plan.js';
import type { EngineLogger } from 'src/engine/Type/EngineLogger.js';
import type { LanguageConfiguration } from 'src/engine/Type/LanguageConfiguration.js';
import { ChangeCodeAction } from 'src/engine/Worker/Action/ChangeCodeAction.js';
import { RangeReplaceEditStrategy } from 'src/engine/Edit/Strategy/RangeReplaceEditStrategy.js';
import { ReplaceEditStrategy } from 'src/engine/Edit/Strategy/ReplaceEditStrategy.js';
import { DiffEditStrategy } from 'src/engine/Edit/Strategy/DiffEditStrategy.js';
import { FullFileEditStrategy } from 'src/engine/Edit/Strategy/FullFileEditStrategy.js';
import type { EditStrategy } from 'src/engine/Edit/EditStrategy.js';
import type { WorkerAction } from 'src/engine/Worker/Action/WorkerAction.js';
import { CodeWorker } from 'src/engine/Worker/CodeWorker.js';
import type { WorkerResult } from 'src/engine/Worker/Worker.js';
import { Task } from 'src/engine/Task/Task.js';
import type { ModelAdapter, RawModelResponse } from 'src/model/Adapter/ModelAdapter.js';
import { OpenAICompatibleModelAdapter } from 'src/model/Adapter/OpenAICompatibleModelAdapter.js';
