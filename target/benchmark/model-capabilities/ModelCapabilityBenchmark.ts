...
import { RangeReplaceEditStrategy } from '@engine/Edit/Strategy/EditStrategyRangeReplace.js';
import { ReplaceEditStrategy } from '@engine/Edit/Strategy/EditStrategyReplace.js';
import { DiffEditStrategy } from '@engine/Edit/Strategy/EditStrategyDiff.js';
import { FullFileEditStrategy } from '@engine/Edit/Strategy/EditStrategyFullFile.js';
...
async function main(): Promise<void> {
  ...
  const runDir = resolve('target/benchmark/model-capabilities/runs', timestamp);
