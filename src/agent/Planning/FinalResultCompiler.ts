...
import type { ExecutionContext } from '@agent/Planning/ExecutionContext';
...
export class FinalResultCompiler {
  public compile(step: PlanStep, task: Task, execution: Execution, context: ExecutionContext): CompiledFinalResult | undefined {
