...
import type { ProjectFileFact, ProjectIndex } from '@engine/Project/ProjectIndex.js';
...
export class ProjectScanner {
  ...
  private async walk(root: string, directory: string, configuration: ProjectConfiguration, output: ProjectFileFact[]): Promise<void> {
