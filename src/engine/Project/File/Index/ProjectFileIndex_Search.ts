...
/**
 * Transitional search adapter inside the ProjectFileIndex family.
 * All behavior delegates to ProjectFileIndex.
 */
export class ProjectFileIndex_Search implements iProjectFileIndex {
